...
> 
> Este documento describe el esquema de la colección **proteins** en MongoDB,
> basada en los ficheros **uniprot_metadata...tsv** y **uniprot_mapping...tsv**.
> 
> ---
> 
...
> 
> # 2. Descargar UniProt (metadata y mapping)
...
> 
> Cada documento utiliza el **Entry** (accession de UniProt) como clave principal (`_id`).  
> La estructura anidada almacena la información de genes asociados, anotaciones GO y comentarios.
> 
> | Nivel | Campo                         | Descripción |
> |-------|-------------------------------|-------------|
> | Nivel 1 | `_id` | Clave principal. Entry de UniProt (ej: `"P04217"`). |
...
> | Nivel 2 | `genes` | Array de documentos con genes asociados. |
> | Nivel 3 | `genes.hgnc_id` | ID de HGNC del gen. |
> | Nivel 3 | `genes.symbol` | Símbolo del gen. |
> | Nivel 2 | `go` | Objeto con anotaciones Gene Ontology. |
> | Nivel 3 | `go.molecular_function` | Array de funciones moleculares. |
> | Nivel 3 | `go.biological_process` | Array de procesos biológicos. |
> | Nivel 3 | `go.cellular_component` | Array de componentes celulares. |
> | Nivel 2 | `comments` | Objeto que agrupa comentarios de curación. |
> | Nivel 3 | `comments.function` | Función de la proteína. |
> | Nivel 3 | `comments.subcellular_location` | Localizaciones subcelulares. |
> 
> ---
> 
